        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh]">
            ...
            <div className="flex-1 overflow-y-auto p-4 text-sm text-slate-700 space-y-4 leading-relaxed">
              ...
              {activeTab === 'common' && (
                <div className="space-y-3">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200">
                    <span className="font-bold text-slate-900 block mb-1 text-base text-emerald-600">🔓 공통 개방 방법</span>
              ...
              {activeTab === 'macao' && (
                <div className="space-y-4">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">1. mgf 노란종이 서랍</span><p className="text-slate-600 text-xs font-medium">Sunglass 옆 <span className="text-amber-600 font-bold">2번</span> 꾹 눌러 재진입 ➡️ <span className="font-mono font-bold text-slate-900">8523</span> 입력</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">2. 미닫이 문</span><p className="text-slate-600 text-xs font-medium">TAG3 옆 <span className="text-amber-600 font-bold">6번</span> 꾹 눌러 재진입 ➡️ 5초 기다린 후 직접 밀어 열기</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">3. 첫번째방 편지 넣는 왼쪽 서랍</span><p className="text-slate-600 text-xs font-medium">오른쪽 자물쇠(<span className="font-mono font-bold">4283</span>) 오픈 ➡️ 스위치 조작 정답 매칭 [ (오)상상중 / (왼)하중하 ] ➡️ 열림</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">4. 책상 오른쪽 키패드 서랍</span><p className="text-slate-600 text-xs font-medium">키패드에 <span className="bg-slate-100 font-mono px-1.5 py-0.5 rounded font-bold">5947#</span> 입력 ➡️ 열림</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">5. 카메라 서랍</span><p className="text-slate-600 text-xs font-medium">Camera 단계 옆 <span className="text-amber-600 font-bold">10번</span> 꾹 눌러 재진입 ➡️ 약 30초 대기 후 자동 개방</p><div className="bg-amber-50 text-amber-800 text-[11px] p-2 rounded-lg border border-amber-200 mt-1 font-bold">※ 주의: 4283 서랍이 열려있으면 카메라 진입 불가! 서랍을 닫아두어야 합니다.</div></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">6. 마지막 방 문</span><p className="text-slate-600 text-xs font-medium">TAG4 옆 <span className="text-amber-600 font-bold">13번</span> 꾹 눌러 재진입 ➡️ 약 30초 대기 후 자동 개방 (CCTV 확인)</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">7. USB 서랍</span><p className="text-slate-600 text-xs font-medium">USB 단계 옆 <span className="text-amber-600 font-bold">15번</span> 꾹 눌러 재진입 ➡️ 열림</p></div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200"><span className="font-bold text-slate-900 block mb-1">8. 에코얼리스 서랍 (책상 아래 파일)</span><p className="text-slate-600 text-xs font-medium">Eco-Uliss 단계 옆 <span className="text-amber-600 font-bold">18번</span> 꾹 눌러 재진입 ➡️ 열림</p></div>
                </div>
              )}
